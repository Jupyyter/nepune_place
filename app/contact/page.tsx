  ...
  return (
    <div className="flex-grow flex items-center justify-center">
      <main className="text-center p-4">
        ...
        <ContactItem icon="phone.jpg" text="my phone number: 0765823655" />
        <ContactItem icon="mail.jpg" text="my email: raducea.matei2005@gmail.com" />
        <ContactItem icon="github.jpg" text="my github repositories" link="https://github.com/Jupyyter?tab=repositories" />
      </main>
    </div>
  );
}